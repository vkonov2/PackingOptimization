...
`rectangle_packing.py`, builds and solves an instance, then produces a
visualization saved to `rectangular_solution.png`.
...
plot of the layout in `rectangular_solution.png`. Coordinates are enumerated on an integer
